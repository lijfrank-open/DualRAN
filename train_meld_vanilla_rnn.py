...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature_mode', default='concat2', help='r1, r2, r3, r4, sum4, concat2, concat4')
    ...
    parser.add_argument('--use_speaker', action='store_true', default=True, help='use speaker')
    parser.add_argument('--rnn_model', default='LSTM', help='LSTM, GRU')
    parser.add_argument('--rnn_layer', type=int, default=5, help='number of rnn_layer')
    parser.add_argument('--attention_head', type=int, default=4, help='number of attention_head')
    parser.add_argument('--attention_layer', type=int, default=8, help='number of attention_layer')
    ...
    if args.classify == 'emotion':
        if args.class_weight:
            loss_weights = torch.FloatTensor([0.469507, 0.119346, 0.026116, 0.073096, 0.168369, 0.026335, 0.117231])
    ...
    if args.classify == 'emotion':
        lf = open('./logs/meld_emotion_logs.txt', 'a')
    elif args.classify == 'sentiment':
        lf = open('./logs/meld_sentiment_logs.txt', 'a')
    lf.write(str(args) + '\n')
